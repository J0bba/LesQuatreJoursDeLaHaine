...
public class IndexerService implements IIndexer {
    ...
    final String REGEX = "[^a-zA-ZáàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ']+";
    ...
    public Document index(String url) {
        ...
        ArrayList<String> textWithoutPunctuation =
                new ArrayList<>(Arrays.asList(fullText.split(REGEX)).stream().map(String::toLowerCase).collect(Collectors.toList()));
